...
def findTheWinner(self, n, k):
        ...
        :rtype: int
        """
        friends = list(range(1, n + 1))  # Create a list of friends from 1 to n
        current_index = 0  # Start at the first friend

        while len(friends) > 1:
            # Calculate the position of the friend to be removed
